...
create table doctor (id varchar(36) not null, active boolean, birth_date date not null, confirmed boolean, cpf varchar(14) not null, created_at timestamp, email varchar(30) not null, gender varchar(8) not null, name varchar(50) not null, password varchar(60) not null, phone varchar(50), reset_password boolean, updated_at timestamp, crm varchar(30), crm_file varchar(255), field varchar(50), rg varchar(20), state varchar(2), primary key (id))

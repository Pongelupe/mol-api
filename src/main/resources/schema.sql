...
create table patient (id varchar(36) not null, active boolean, birth_date date, confirmed boolean, cpf varchar(13) not null, created_at timestamp, email varchar(30) not null, gender varchar(8), password varchar(15) not null, phone varchar(50), reset_password boolean, updated_at timestamp, primary key (id))
